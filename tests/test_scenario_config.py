...
def test_yaml_round_trip_simple():
    ...
    assert round_trip_dict["new_load_of_map_data"] == original_dict["new_load_of_map_data"]
    assert len(round_trip_dict["map_data_files"]) == len(original_dict["map_data_files"])
...
def test_yaml_round_trip_with_optional_fields():
    ...
    assert round_trip_dict["episode_generation"]["n_episodes"] == original_dict["episode_generation"]["n_episodes"]
    assert (
